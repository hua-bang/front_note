...
## 布尔值[§](https://ts.xcatliu.com/basics/primitive-data-types.html#布尔值)
...
## 数值[§](https://ts.xcatliu.com/basics/primitive-data-types.html#数值)
...
## 字符串[§](https://ts.xcatliu.com/basics/primitive-data-types.html#字符串)
...
## 空值[§](https://ts.xcatliu.com/basics/primitive-data-types.html#空值)
