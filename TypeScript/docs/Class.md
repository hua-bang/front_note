...
## ES6 中类的用法[§](https://ts.xcatliu.com/advanced/class.html#es6-中类的用法)
...
## ES7 中类的用法[§](https://ts.xcatliu.com/advanced/class.html#es7-中类的用法)
...
## TypeScript 中类的用法[§](https://ts.xcatliu.com/advanced/class.html#typescript-中类的用法)
